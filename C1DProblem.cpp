...
C1DProblem prToro1Idealtest = C1DProblem("Toro-1", 1.,           .75,      1.,    .125,       0.,      .1,  0., 1., 0.,   .2, .3, 100, .8, "tt");
...
C1DProblem prToro5Idealtest = C1DProblem("Toro-5-gps", 1.,     -19.59745,   1000.,      1., -19.59745,     .01,  0., 1., 0., .012, .8, 100, .9, "tt");
