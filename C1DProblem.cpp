...
// 5 Toro tests
C1DProblem prToro1Idealtest = C1DProblem("Toro-1-gamma=3.9", 1.,           .75,      1.,    .125,       0.,      .1,  0., 1., 0.,   .2, .3, 100, .3, "tt");
...
C1DProblem prLaserVTAlMGTest1 = C1DProblem("LaserVTAl1-MG-1nm-hllc-300", 2700., 0., 19.4872e9, 2700., 0., 300.e9, -50.e-9, 50.e-9, 0., 3.e-12, 0., 300, .9, "tt");