...
/*	virtual double   getdpdro(double ro, double ti, double te)=0;
	virtual double  getdpdroe(double ro, double ti, double te)=0;
	virtual double getdpdroei(double ro, double ti, double te)=0;

	

	virtual double getdpdt   (double ro, double ti, double te)=0;
	virtual double getdedt   (double ro, double ti, double te)=0;
*/
...
/*
	double   getdpidro_ti(double ro, double ti);
	double   getdpidti_ro(double ro, double ti);
	double   getdeidro_ti(double ro, double ti);
	double   getdeidti_ro(double ro, double ti);
	*/
