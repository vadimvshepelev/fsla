...
double EOSTableFeAlpha::getpi(double ro, double ti)
{
...
double EOSTableFeAlpha::getei(double ro, double ti) 
{ 
...
double EOSTableFeAlpha::getti(double ro, double ei) 
{
	double ti = solve_ti(ro, ei, t_scale.getMin()+1.0, t_scale.getMax()-1.0);
	return ti;
}

double EOSTableFeAlpha::getti_interp(double ro, double ei)
{
	
	return 0.0;
}

double EOSTableFeAlpha::getC(double ro, double ti, double te, double v) {
	return 3000.;
}

double EOSTableFeAlpha::getphase(double ro, double ti)
{
	double phase = phase_table.interpolate(ro, ti);
	return phase;
}

double EOSTableFeAlpha::getmix(double ro, double ti)
{
...
double EOSTableFeAlpha::getnuWR(double ro, double ti, double te, double b, double Z)
{
	// Constants	
	/*
	double kB  = 1.38e-16;
...
double EOSTableFeAlpha::getkappa(double ro, double ti, double te, double Z=3.0)
{
