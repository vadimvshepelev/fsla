...
//	delete s;
	...
	s->goEuler("task-toro-3.txt"); // для Эйлеровых задач
	...
	//s->goEuler("task-eosbin-test-1.txt"); // Тест на двучленное УРС от Паши
	//s->goEuler("task-eosbin-toro-test-3.txt"); // Тест на двучленное УРС (при нулевых параметрах должно работать как идеальное)
