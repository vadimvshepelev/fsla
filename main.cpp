...
//	delete s;
	...
	s->goEuler("task-LH1D-p=120GPA.txt"); // «адача LH (стекло-золото-вакуум), одномерное приближение, с более мелкой ступенькой

	
	//s->goEuler("task-LH1D-aux-1.txt"); // «адача LH (стекло-золото-вакуум), левый разрыв стекло-золото
	//s->goEuler("task-eosbin-test-1.txt"); // ѕервый тест √лайстера по двучленному уравнению состо€ни€
	delete s;
