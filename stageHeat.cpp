...
void CSolver::sweepTe(CFieldOld& ms_temp, CFieldOld& ms_temp_temp, double *A, double *B, double *C, double *F,
...
void CSolver::sweepTi(CFieldOld& ms_temp, CFieldOld& ms_temp_temp, 
